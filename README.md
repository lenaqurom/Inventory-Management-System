...
This console-based application allows you to manage a list of products, where each product has a **name**, **price**, and **quantity** in stock.  
The system supports basic operations such as **adding**, **viewing**, **editing**, **deleting**, and **searching** for products.
...
InventoryManagement/
│
├── Storage/             # Defines storages for products and inventory
├── Models/              # Contains classes representing products and inventory
├── Management/          # Implements business logic for inventory operations
